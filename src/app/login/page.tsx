        ...
        <div className="rounded-3xl overflow-hidden" style={{ background: "var(--surface-1)", boxShadow: "var(--shadow-xl)", border: "1px solid var(--border)" }}>
          ...
          {!mfaStep ? (
            ...
            <div className="px-8 pt-6 pb-8">
              ...
              <button onClick={() => { setMfaStep(false); setMfaCode(["","","","","",""]); setError(""); }} className="w-full py-2.5 text-[13px] font-medium mt-3 tr rounded-xl" style={{ color: "var(--text-3)" }}>← Back to sign in</button>
